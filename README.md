...
* 'waterfront' which has 1 column ('waterfront_YES) and 1 reference category ('waterfront_NO')             
* 'month_sold' which has 11 columns (2 (February) - 12 (December)) and 1 reference category (1 (January))                               
